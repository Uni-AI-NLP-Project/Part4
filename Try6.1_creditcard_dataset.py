...
STATE_FILE_NAME: str = "creditcard best model (val F1 = 0.86772) (128, 128, 128, 128, 128, 128, 128, 64, 32).pth"
TEST_ONLY = True
DATA_SPLIT_RANDOM_STATE = 12345

IN_LAYER_SIZE = 30
HIDDEN_LAYER_SIZES: tuple = (128, 128, 128, 128, 128, 128, 128, 64, 32)
OUT_LAYER_SIZE = 1
POS_WEIGHT_AMOUNT = 284807 / 492
DROPOUT_AMOUNT = 0.3
...
# noinspection PyShadowingNames
def train_model(model: NeuralNetworkBinary, X_train, X_val, y_train, y_val, epochs, device):
...
if __name__ == '__main__':
    ...
    X_train, X_val, X_test, y_train, y_val, y_test = load_data('creditcard.csv')

    # Initialize model
    model = NeuralNetworkBinary().to(DEVICE)
    if STATE_FILE_NAME != "":
    ...
    with torch.inference_mode():
        ...
        print(f"Test acc = {test_acc:.5f}, Test F1 = {f1t:.5f}")
