...
load_file_name: str = "try4_about_200k_epochs"
epochs = 100000
con_matrix = True  # IMMENSLY SLOWS TRAINING IF SET TRUE SINCE FUNCTION WILL MOVE STUFF TO CPU
...
def f1score(_confusion_matrix):
    ...
    :return:
    """
    return ((2 * _confusion_matrix[1, 1]) /
            (2 * _confusion_matrix[1, 1] + _confusion_matrix[0, 1] + _confusion_matrix[1, 0]))
